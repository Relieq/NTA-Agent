...
_SYSTEM = (
    ...
    "'1 army of pawn 3206 + 4 armies of pawn 3305'). It is ONE-SHOT: the hands clear it "
    "automatically once the group is assembled — do NOT re-send a goal on your own; only set "
    "it when the user asks for a (new) group. Set [] to clear the goal. If it's not "
